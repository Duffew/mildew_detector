...
def show():
    ...
    def data_visual_body():
        ...
        - Passes user selection to `image_montage()` for dynamic image display.
        """
        ...
        if st.checkbox(
            ...
            - The average healthy leaf looks to have a relatively consistent
                     shade of green suggesting even chlorophyll distribution.
            - The variation image for healthy leaves shows a black centre
                     with minimal green hue, shifting to a purple ring
                     at the edge.
            ...
            Healthy cherry leaves will show little if any meaningful
                     difference in appearance at their centres
            ...
            if avg_healthy_path.exists():
                ...
                st.warning(
                    "Image file not found. Please check your file paths.")
            ...
            - The average mildewed leaf looks to have a blotchy appearance
                     and lighter shade indicating chlorophyll depletion.
            - The variation image for mildewed leaves shows a greenish hue in
                     the centre becoming a subdued purple ring towards
                     the edge.

            This suggests:

            - Some variance across mildewed leaves at the centre - greater
                     than that of a healthy leaf.
            - Greater variance in mildewed leaves towards the edge.

            Conclusion:

            Cherry leaves infected with powdery mildew exhibit similar
                     characteristics at the centre of the leaf,
            albeit with some variations. The variances at the centre,
            ...
            if avg_mildew_path.exists():
                ...
                st.warning(
                    "Image files not found. Please check your file paths.")
        ...
        if st.checkbox(
            ...
            - The average mildewed leaf looks to have a blotchy appearance
                     and lighter shade indicating chlorophyll depletion
                     in some areas.
            - The image representing the difference between average images
                     shows a large black centre with purple and green edges.

            This suggests:

            - Minimal to no differences between average healthy and
                     average mildewed leaves at the centre.
            - Greater variation between average healthy and average
                     mildewed leaves at the edges.
            """)
            ...
            if avg_diff_path.exists():
                ...
                st.warning(
                    "Image file not found. Please check your file path.")
            st.write("---")
